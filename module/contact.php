...
<script language="javascript">
    function btnSend_onclick() {
        ...
        if (test_empty(document.frmContact.txtDetail.innerText)) {
            alert(mustInput_Detail);
            document.frmContact.txtDetail.focus();
            return false;
        }
        return true;
    }
...
<form method="POST" name="frmContact" action="./">
    ...
    <table align="center" width="95%" cellpadding="0" cellspacing="0">
        ...
        <tr><td align="center" style="padding-right:80px"><?php if ($errMsg != '') {
            ...
            <td>
                ...
                <table border="0" width="100%" cellspacing="1" cellpadding="0" style="border-collapse:collapse">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;<input class="textbox" size=30 name="txtName" value=""></td>

                    </tr>

                    <tr>
                        <td align="right" class="normalFont"><?php echo $l_congty ?> : </td>
                        <td>&nbsp;<input class="textbox" size=30 name="txtCompany" value=""></td>
                    </tr>

                    <tr>
                        <td align="right" class="normalFont"><?php echo $l_diachi ?> : </td>
                        <td>&nbsp;<input class="textbox" size=30 name="txtAddress" value=""></td>
                    </tr>

                    <tr>
                        <td align="right" class="normalFont"><font color="#FF0000">*</font> <?php echo $l_email ?> : </td>
                        <td>&nbsp;<input class="textbox" size=30 name="txtEmail" value=""></td>
                    </tr>

                    <tr>
                        <td align="right" class="normalFont"><?php echo $l_website ?> : </td>
                        <td>&nbsp;<input class="textbox" size=30 name="txtWebsite" value=""></td>
                    </tr>

                    <tr>
                        <td align="right" class="normalFont"><?php echo $l_dt ?> : </td>
                        <td>&nbsp;<input class="textbox" size=30 name="txtTel" value=""></td>
                    </tr>

                    <tr>
                        <td align="right" class="normalFont"><?php echo $l_dtdd ?> : </td>
                        <td>&nbsp;<input class="textbox" size=30 name="txtMobile" value=""></td>
                    </tr>

                    <tr>
                        <td align="right" class="normalFont"><?php echo $l_fax ?> : </td>
                        <td>&nbsp;<input class="textbox" size=30 name="txtFax" value=""></td>
                    </tr>
